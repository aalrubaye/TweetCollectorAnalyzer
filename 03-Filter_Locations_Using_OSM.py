...
database = connection.twit_filtered6
t_mongo = database.tdf6
twit = t_mongo.find()
print twit.count()
...
# #                     mm+=1
# #                     print str(mm)+ ' : ' +str(loc)+' - (USA) / ('+ str(row['created_at']) +') ** MY'
# #                 else:
# #                     if (' ' + sep[0].lower()+' ' in states.lower()):
# #                         st_name = abv_to_state(sep[0].lower())
# #                         t_u.insert({'city': "", 'state': st_name, 'data': row})
# #                         mm+=1
# #                         print str(mm)+ ' : ' +str(loc)+' - (state = '+st_name+') / ('+ str(row['created_at']) +') ** MY'
# #                     else:
# #                         g = ''
# #                         g = find_in_match(loc)
# #                         if g != '':
...
# #                                 mm+=1
# #                                 print str(mm)+ ' : ' +str(loc)+' - ( city = '+ctst[0]+', state = '+ctst[1]+') / ('+ str(row['created_at']) +') -- Found in Match'
# #                         else:
...
# #                                         t_u.insert({'city': ctst[0], 'state': ctst[1], 'data': row})
# #                                         mm+=1
# #                                         print str(mm)+ ' : ' +str(loc)+' - ( city = '+ctst[0]+', state = '+ctst[1]+' ) / ('+ str(row['created_at']) +') -- Using Google'
# #                                         google_usage +=1
...
# #                     mm+=1
# #                     print str(mm)+ ' : ' +str(loc)+' - ( city = '+sep[0]+', state = '+sep[1]+') / ('+ str(row['created_at']) +') ** MY'
# #                 else:
# #                     g = ''
# #                     g = find_in_match(loc)
# #                     if g != '':
