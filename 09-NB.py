...
SSS = 'West Virginia'
LLL = 200
# db = sqlite3.connect('/Users/Abduljaleel/Desktop/project/SQLite/'+SSS+'2')
...
#
# create('cancer','000030000',location3);create('cancer','000060000',location6);create('cancer','000120000',location12)

# create('clrd','000030000',location3); create('clrd','000060000',location6); create('clrd','000120000',location12)

create('stroke','000030000',location3);
# create('stroke','000060000',location6); create('stroke','000120000',location12)
...
# db1 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_heart')
# db2 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_cancer')
# db3 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_clrd')
# db4 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_stroke')
# db5 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_alzheimer')
# db6 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_diabetes')
# db7 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_flu_or_pneumonia')
# db8 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_kidney')
# db9 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_septicemia')
# db10 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_liver')
# db11 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_hyper')
# db12 = sqlite3.connect(loc+SSS+'/SQLite/'+SSS+'_parkinson')
# c1 = db1.cursor(); c2 = db2.cursor(); c3 = db3.cursor(); c4 = db4.cursor()
# c5 = db5.cursor(); c6 = db6.cursor(); c7 = db7.cursor(); c8 = db8.cursor()
# c9 = db9.cursor(); c10 = db10.cursor(); c11 = db11.cursor(); c12 = db12.cursor()
#
#
#
# create('heart','000030000',location3,db1,c1); create('heart','000060000',location6,db1,c1); create('heart','000120000',location12,db1,c1)
#
# create('cancer','000030000',location3,db2,c2); create('cancer','000060000',location6,db2,c2); create('cancer','000120000',location12,db2,c2)
#
# create('clrd','000030000',location3,db3,c3); create('clrd','000060000',location6,db3,c3); create('clrd','000120000',location12,db3,c3)
#
# create('stroke','000030000',location3,db4,c4); create('stroke','000060000',location6,db4,c4); create('stroke','000120000',location12,db4,c4)
#
# create('alzheimer','000030000',location3,db5,c5); create('alzheimer','000060000',location6,db5,c5); create('alzheimer','000120000',location12,db5,c5)
#
# create('diabetes','000030000',location3,db6,c6); create('diabetes','000060000',location6,db6,c6); create('diabetes','000120000',location12,db6,c6)
#
# create('flu_or_pneumonia','000030000',location3,db7,c7); create('flu_or_pneumonia','000060000',location6,db7,c7); create('flu_or_pneumonia','000120000',location12,db7,c7)
#
# create('kidney','000030000',location3,db8,c8); create('kidney','000060000',location6,db8,c8); create('kidney','000120000',location12,db8,c8)
#
# create('septicemia','000030000',location3,db9,c9); create('septicemia','000060000',location6,db9,c9); create('septicemia','000120000',location12,db9,c9)
#
# create('liver','000030000',location3,db10,c10); create('liver','000060000',location6,db10,c10); create('liver','000120000',location12,db10,c10)
#
# create('hyper','000030000',location3,db11,c11); create('hyper','000060000',location6,db11,c11); create('hyper','000120000',location12,db11,c11)
#
# create('parkinson','000030000',location3,db12,c12); create('parkinson','000060000',location6,db12,c12); create('parkinson','000120000',location12,db12,c12)
